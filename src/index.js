...
// Shared bucket/hashing machinery for HashMap and HashSet: both store
// entries in the same array-of-buckets layout and only differ in whether
// a bucket holds `[key, value]` pairs or bare keys.
class HashTable {
